...
namespace BBERP.Pages
{
    public static class MainMenu
    {
        ...
        {
            public const string PageName = "Material";
            public const string RoleName = "RawMaterial";
            public const string Path = "/RawMaterial/Index";
            public const string ControllerName = "RawMaterial";
            public const string ActionName = "Index";
        }
        public static class MaterialType
        {
            public const string PageName = "MaterialType";
            public const string RoleName = "MaterialType";
            public const string Path = "/MaterialType/Index";
            public const string ControllerName = "MaterialType";
            public const string ActionName = "Index";
        }
        ...
        {
            public const string PageName = "CountryMaster";
            public const string RoleName = "CountryMaster";
            public const string Path = "/CountryMaster/Index";
            public const string ControllerName = "CountryMaster";
            public const string ActionName = "Index";
        }
    }
}
